...
% COL - color of the autocorrelation barplot 
%
% OUTPUT:
...
%
% EXAMPLE:
% sa = acf(randn(100,1), 10, 'b')


function ta = acf(y, p, COL)
...
hold on
bar(ta,'FaceColor',COL)
line([0 p+.5], 0*ones(1,2),'Color','k', 'Linewidth',1)
line([0 p+.5], (1.96)*(1/sqrt(N))*ones(1,2),'Color','k', 'Linewidth',1)
line([0 p+.5], (-1.96)*(1/sqrt(N))*ones(1,2),'Color','k', 'Linewidth',1)
hold off
